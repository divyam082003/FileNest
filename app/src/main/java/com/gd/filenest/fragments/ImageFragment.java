...
import com.gd.filenest.databinding.FragmentImageBinding;
...
public class ImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (argPath.equals(apps[0])){
            ...
            pagerAdapter.addFragment(new ImageFolderFragment(),"Albums");
        }
        else if (argPath.equals(apps[1])){
            binding.tvTitle.setText(apps[1]);
            pagerAdapter.addFragment(new SongFragment(),"Audio");
