...
import com.gd.filenest.adapters.SongAdapter;
import com.gd.filenest.databinding.FragmentSongBinding;
    ...
    private void setData() {
        ...
        Executors.newSingleThreadExecutor().execute(new Runnable() {
            ...
            public void run() {
                ...
                songAdapter.addAll(allAudio,SongFragment.this,binding.noData);
            }
        });
    }
