...
import com.gd.filenest.databinding.FileItemBinding;
import com.gd.filenest.fragments.SelectAppsFragment;
...
public class AppsAdapter extends RecyclerView.Adapter<AppsAdapter.AppsViewHolder> implements Filterable {
    ...
    public void addAll(ArrayList<File> appsList, Fragment fragment, LinearLayout linearLayout){
        this.appsList.clear();
