...
import com.gd.filenest.databinding.FileItem2Binding;
import com.gd.filenest.databinding.FolderItemBinding;
import com.gd.filenest.databinding.LargeFileItemBinding;
import com.gd.filenest.fragments.SelectStorageFragment;
...
public class StorageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public void addAll(ArrayList<File> files, Fragment fragment, LinearLayout linearLayout) {
        this.files.clear();
        ...
        this.files.addAll(regularFiles);
