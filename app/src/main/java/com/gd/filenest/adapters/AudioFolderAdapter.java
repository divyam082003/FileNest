...
import com.gd.filenest.databinding.MediaFolderItemBinding;
import com.gd.filenest.fragments.SelectVideoFolderFragment;
...
public class AudioFolderAdapter extends RecyclerView.Adapter<AudioFolderAdapter.AudioFolderViewHolder> implements Filterable {
    ...
    public void addAll(ArrayList<MediaModel> fileList, Fragment fragment,  LinearLayout linearLayout) {
        this.fileList.clear();
